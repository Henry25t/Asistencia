...
public class DocenteController {
    ...
    @PostMapping("/save")
    public String save(@ModelAttribute Docente pDocente, BindingResult result, Model model, RedirectAttributes attributes)
    {
        if(result.hasErrors()){
        ...
        if(pDocente.getId() != null && pDocente.getId() > 0){
            docenteService.createOrEditOne(pDocente);
